import { r as react, c as createCommonjsModule, g as getDefaultExportFromCjs } from './common/index-c49dc486.js';
...
var skeletonKeyframes = (0, core_browser_esm.keyframes)(_templateObject());
exports.skeletonKeyframes = skeletonKeyframes;
var skeletonStyles =
/*#__PURE__*/
(0, core_browser_esm.css)("background-color:", defaultBaseColor, ";background-image:linear-gradient( 90deg,", defaultBaseColor, ",", defaultHighlightColor, ",", defaultBaseColor, " );background-size:200px 100%;background-repeat:no-repeat;border-radius:4px;display:inline-block;line-height:1;width:100%;;label:skeletonStyles;" + ( "" ));
...
function Skeleton(_ref) {
  ...
  for (var i = 0; i < count; i++) {
    ...
    elements.push((0, core_browser_esm.jsx)("span", {
      key: i,
      className: className,
      css:
      /*#__PURE__*/
      (0, core_browser_esm.css)(skeletonStyles, " animation:", skeletonKeyframes, " ", duration, "s ease-in-out infinite;label:Skeleton;" + ( "" )),
      style: _objectSpread({}, customStyle, {}, style)
    }, "\u200C"));
  }

  return (0, core_browser_esm.jsx)("span", null, Wrapper ? elements.map(function (element, i) {
    return (0, core_browser_esm.jsx)(Wrapper, {
      key: i
    }, element, "\u200C");
  }) : elements);
}
...
function (_Component) {
  ...
  _createClass(SkeletonTheme, [{
    ...
    value: function render() {
      ...
      var themeStyles =
      /*#__PURE__*/
      (0, core_browser_esm.css)(".react-loading-skeleton{background-color:", color, ";background-image:linear-gradient( 90deg,", color, ",", highlightColor, ",", color, " );};label:SkeletonTheme;" + ( "" ));
      return (0, core_browser_esm.jsx)("div", {
        css: themeStyles
      }, children);
    }
  }]);
